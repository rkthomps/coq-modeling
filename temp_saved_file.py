...
class ProofState(object):
    ...
    def __init__(self, coq_file: CoqFile, coq_file_context: Optional[FileContext] = None):
        """Creates a ProofState

        Args:
            coq_file (CoqFile): Coq file to interact with
            coq_file_context (Optional[FileContext]): File context of the coq file
