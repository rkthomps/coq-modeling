...
from model_deployment.mine_goal_strtrees import mine_coq_file_goals, GoalTermRecord
...
TEST_FILE = "repos/inQWIRE-QWIRE/Monoid.v"
...
with CoqFile(os.path.abspath(TMP_LOC), workspace=workspace_loc) as coq_file:
    ...
    record_gen = mine_coq_file_goals(coq_file, file_info, split, DATA_PREFIX)
