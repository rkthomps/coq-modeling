from model_deployment.term_compare import (
    term_p,
    app_p,
    AppT,
    VarT,
...
class TestTermCompare:
    ...
    def test_failure_1(self) -> None:
        ...
        test_res = ProdT(
            [Param("_", AppT(VarT("eq"), [VarT("1"), VarT("3")]))], VarT("False")
        )
    ...
    def test_failure_2(self) -> None:
        ...
        test_res = AppT(
            VarT("a"), [VarT("1"), ProdT([Param("_", VarT("True"))], VarT("False"))]
        )
        assert term_p.parse(test_str) == test_res
    ...
    def test_failure_6(self) -> None:
        ...
        test_res = FixT("cat", [Param("a", VarT("nat"))], VarT("nat"), VarT("1"))
        assert test_res == term_p.parse(test_str)
