{
  "file_context": [
    "{\"file\": \"repos/yalhessi-verified-verifier/Maps.v\", \"workspace\": \"repos/yalhessi-verified-verifier\", \"repository\": \"repos/yalhessi-verified-verifier\"}",
    ...
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition total_map (A B:Type) := A -> B.\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 0}",
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition t_update {A B : Type} (eq_dec:forall (x y:A),{x=y}+{x<>y}) (f:total_map A B) (x:A) (v:B) : total_map A B := fun y => if eq_dec x y then v else f y.\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 3}",
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition t_get {A} {B} (f:total_map A B) (x:A) : B := f x.\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 6}",
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition t_empty {A} {B} (v:B) : total_map A B := fun (_ : A) => v.\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 9}",
    "{\"type\": \"TermType.LEMMA\", \"text\": \"Lemma t_apply_empty: forall A B x v, @t_empty A B v x = v.\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 13}",
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition partial_map (A B:Type) := total_map A (option B).\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 86}",
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition empty {A B: Type} : partial_map A B := t_empty None.\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 88}",
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition update {A B: Type} (eq_dec:forall (x y:A),{x=y}+{x<>y}) (m: partial_map A B) (k: A) (v: B) := t_update eq_dec m k (Some v).\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 91}",
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition member {A B: Type} (m : partial_map A B) (k: A) := match (m k) with | Some _ => true | None => false end.\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 94}",
    "{\"type\": \"TermType.LEMMA\", \"text\": \"Lemma apply_empty : forall A B x, @empty A B x = None.\", \"file_path\": \"repos/yalhessi-verified-verifier/Maps.v\", \"module\": [], \"line\": 100}"
  ],
  "proofs": [
    {
      "theorem": {
        "type": "TermType.LEMMA",
        "text": "Lemma t_apply_empty: forall A B x v, @t_empty A B v x = v.",
        "file_path": "repos/yalhessi-verified-verifier/Maps.v",
        "module": [],
        "line": 13,
        "context": [
          {
            ...
            "file_path": "../root/.opam/default/lib/coq/theories/Init/Logic.v",
            "module": [],
            "line": 388
          },
          {
            "type": "TermType.DEFINITION",
            "text": "Definition t_empty {A} {B} (v:B) : total_map A B := fun (_ : A) => v.",
            "file_path": "repos/yalhessi-verified-verifier/Maps.v",
            "module": [],
            "line": 9
          }
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "\n\nforall (A B : Type) (x : A) (v : B), t_empty v x = v"
          ]
        },
        {
          "term": {
    ...
    },
    {
      "theorem": {
        "type": "TermType.LEMMA",
        "text": "Lemma apply_empty : forall A B x, @empty A B x = None.",
        "file_path": "repos/yalhessi-verified-verifier/Maps.v",
        "module": [],
        "line": 100,
        "context": [
          ...
          {
            "type": "TermType.DEFINITION",
            "text": "Definition empty {A B: Type} : partial_map A B := t_empty None.",
            "file_path": "repos/yalhessi-verified-verifier/Maps.v",
            "module": [],
            "line": 88
          },
          {
            ...
            "text": "#[universes(template)] Inductive option (A:Type) : Type := | Some : A -> option A | None : option A.",
            "file_path": "../root/.opam/default/lib/coq/theories/Init/Datatypes.v",
            "module": [],
            "line": 182
          }
        ]
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "\n\nforall (A B : Type) (x : A), empty x = None"
          ]
        },
        {
          "term": {
