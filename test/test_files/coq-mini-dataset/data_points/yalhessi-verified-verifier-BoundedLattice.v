{
  "file_context": [
    "{\"file\": \"repos/yalhessi-verified-verifier/BoundedLattice.v\", \"workspace\": \"repos/yalhessi-verified-verifier\", \"repository\": \"repos/yalhessi-verified-verifier\"}",
    ...
    "{\"type\": \"TermType.INDUCTIVE\", \"text\": \"Inductive BoundedSet : Set := | top | bounded | bottom.\", \"file_path\": \"repos/yalhessi-verified-verifier/BoundedLattice.v\", \"module\": [], \"line\": 2}",
    "{\"type\": \"TermType.INDUCTIVE\", \"text\": \"Inductive BoundedRel : BoundedSet -> BoundedSet -> Prop := | bot_rel x : BoundedRel bottom x | self_rel x : BoundedRel x x | bounded_top_rel : BoundedRel bounded top.\", \"file_path\": \"repos/yalhessi-verified-verifier/BoundedLattice.v\", \"module\": [], \"line\": 7}",
    "{\"type\": \"TermType.INSTANCE\", \"text\": \"Program Instance BoundedOrder : Order BoundedSet := { ord := BoundedRel }.\", \"file_path\": \"repos/yalhessi-verified-verifier/BoundedLattice.v\", \"module\": [], \"line\": 12}",
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition meet_BoundedSet (a : BoundedSet) (b : BoundedSet) : BoundedSet := match a with | top => b | bounded => match b with | top => bounded | _ => b end | bottom => bottom end.\", \"file_path\": \"repos/yalhessi-verified-verifier/BoundedLattice.v\", \"module\": [], \"line\": 27}",
    "{\"type\": \"TermType.DEFINITION\", \"text\": \"Definition join_BoundedSet (a : BoundedSet) (b : BoundedSet) : BoundedSet := match a with | bottom => b | bounded => match b with | bottom => bounded | _ => b end | top => top end.\", \"file_path\": \"repos/yalhessi-verified-verifier/BoundedLattice.v\", \"module\": [], \"line\": 38}",
    "{\"type\": \"TermType.INSTANCE\", \"text\": \"Program Instance BoundedLattice : Lattice BoundedSet := { meet := meet_BoundedSet; join := join_BoundedSet; (*meet_commutative : forall a b, a \\u2293 b = b \\u2293 a; meet_associative : forall a b c, (a \\u2293 b) \\u2293 c = a \\u2293 (b \\u2293 c); meet_absorptive : forall a b, a \\u2293 (a \\u2294 b) = a; meet_idempotent : forall a, a \\u2293 a = a; join_commutative : forall a b, a \\u2294 b = b \\u2294 a; join_associative : forall a b c, (a \\u2294 b) \\u2294 c = a \\u2294 (b \\u2294 c); join_absorptive : forall a b, a \\u2294 (a \\u2293 b) = a; join_idempotent : forall a, a \\u2294 a = a*) }.\", \"file_path\": \"repos/yalhessi-verified-verifier/BoundedLattice.v\", \"module\": [], \"line\": 49}",
    "{\"type\": \"TermType.INSTANCE\", \"text\": \"Program Instance BoundedLOSet : LOSet BoundedOrder BoundedLattice.\", \"file_path\": \"repos/yalhessi-verified-verifier/BoundedLattice.v\", \"module\": [], \"line\": 89}"
  ],
  "proofs": [
    {
      "theorem": {
        ...
        "file_path": "repos/yalhessi-verified-verifier/BoundedLattice.v",
        "module": [],
        "line": 13,
        "context": [
          {
            "type": "TermType.INDUCTIVE",
            "text": "Inductive BoundedSet : Set := | top | bounded | bottom.",
            "file_path": "repos/yalhessi-verified-verifier/BoundedLattice.v",
            "module": [],
            "line": 2
          },
          {
            "type": "TermType.INDUCTIVE",
            "text": "Inductive BoundedRel : BoundedSet -> BoundedSet -> Prop := | bot_rel x : BoundedRel bottom x | self_rel x : BoundedRel x x | bounded_top_rel : BoundedRel bounded top.",
            "file_path": "repos/yalhessi-verified-verifier/BoundedLattice.v",
            "module": [],
            "line": 7
          }
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "\n\nRelationClasses.Reflexive BoundedRel"
          ]
        },
        {
          "term": {
          ...
          "n_step": 2,
          "goals": [
            "\n\nforall x : BoundedSet, BoundedRel x x"
          ]
        },
        {
          "term": {
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "\n\nRelationClasses.Transitive BoundedRel"
          ]
        },
        {
          "term": {
        ...
        },
        {
          ...
          "n_step": 3,
          "goals": [
            "\n\nforall x y z : BoundedSet, BoundedRel x y -> BoundedRel y z -> BoundedRel x z"
          ]
        },
        {
          "term": {
          ...
          "n_step": 4,
          "goals": [
            "H: BoundedRel bottom bounded\nH0: BoundedRel bounded top\nx: BoundedSet\nH2: x = bounded\n\nBoundedRel bottom top"
          ]
        },
        {
          "term": {
      ...
      "theorem": {
        ...
        "context": [
          ...
          },
          {
            ...
            "text": "Definition meet_BoundedSet (a : BoundedSet) (b : BoundedSet) : BoundedSet := match a with | top => b | bounded => match b with | top => bounded | _ => b end | bottom => bottom end.",
            "file_path": "repos/yalhessi-verified-verifier/BoundedLattice.v",
            "module": [],
            "line": 27
          },
          {
            "type": "TermType.DEFINITION",
            "text": "Definition join_BoundedSet (a : BoundedSet) (b : BoundedSet) : BoundedSet := match a with | bottom => b | bounded => match b with | bottom => bounded | _ => b end | top => top end.",
            "file_path": "repos/yalhessi-verified-verifier/BoundedLattice.v",
            "module": [],
            "line": 38
          }
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "a, b: BoundedSet\n\nmeet_BoundedSet a b = meet_BoundedSet b a"
          ]
        },
        {
          "term": {
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "a, b, c: BoundedSet\n\nmeet_BoundedSet (meet_BoundedSet a b) c =\nmeet_BoundedSet a (meet_BoundedSet b c)"
          ]
        },
        {
          "term": {
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "a, b: BoundedSet\n\nmeet_BoundedSet a (join_BoundedSet a b) = a"
          ]
        },
        {
          "term": {
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "a, b: BoundedSet\n\njoin_BoundedSet a b = join_BoundedSet b a"
          ]
        },
        {
          "term": {
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "a, b, c: BoundedSet\n\njoin_BoundedSet (join_BoundedSet a b) c =\njoin_BoundedSet a (join_BoundedSet b c)"
          ]
        },
        {
          "term": {
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "a, b: BoundedSet\n\njoin_BoundedSet a (meet_BoundedSet a b) = a"
          ]
        },
        {
          "term": {
        ...
        "context": [
          {
            ...
            "text": "Program Instance BoundedOrder : Order BoundedSet := { ord := BoundedRel }.",
            "file_path": "repos/yalhessi-verified-verifier/BoundedLattice.v",
            "module": [],
            "line": 12
          },
          {
            "type": "TermType.INSTANCE",
            "text": "Program Instance BoundedLattice : Lattice BoundedSet := { meet := meet_BoundedSet; join := join_BoundedSet; (*meet_commutative : forall a b, a \u2293 b = b \u2293 a; meet_associative : forall a b c, (a \u2293 b) \u2293 c = a \u2293 (b \u2293 c); meet_absorptive : forall a b, a \u2293 (a \u2294 b) = a; meet_idempotent : forall a, a \u2293 a = a; join_commutative : forall a b, a \u2294 b = b \u2294 a; join_associative : forall a b c, (a \u2294 b) \u2294 c = a \u2294 (b \u2294 c); join_absorptive : forall a b, a \u2294 (a \u2293 b) = a; join_idempotent : forall a, a \u2294 a = a*) }.",
            "file_path": "repos/yalhessi-verified-verifier/BoundedLattice.v",
            "module": [],
            "line": 49
          }
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "a, b: BoundedSet\n\nBoundedRel a b <-> a = meet_BoundedSet a b"
          ]
        },
        {
          "term": {
          ...
          "goals": [
            "a, b: BoundedSet\n\nBoundedRel a b -> a = meet_BoundedSet a b",
            "a, b: BoundedSet\n\na = meet_BoundedSet a b -> BoundedRel a b"
          ]
        },
        {
          "term": {
        ...
        },
        {
          ...
          "step": {
            "text": " induction a; induction b; auto; unfold meet_BoundedSet; inversion H.",
            "context": [
              {
                "type": "TermType.DEFINITION",
                "text": "Definition meet_BoundedSet (a : BoundedSet) (b : BoundedSet) : BoundedSet := match a with | top => b | bounded => match b with | top => bounded | _ => b end | bottom => bottom end.",
        ...
        },
        {
          ...
          "step": {
            "text": " induction a; induction b; auto; unfold meet_BoundedSet in H; inversion H;\n    try apply bot_rel; try apply self_rel; try apply bounded_top_rel.",
            "context": [
              {
                "type": "TermType.DEFINITION",
                "text": "Definition meet_BoundedSet (a : BoundedSet) (b : BoundedSet) : BoundedSet := match a with | top => b | bounded => match b with | top => bounded | _ => b end | bottom => bottom end.",
      ...
      "steps": [
        {
          ...
          "n_step": 1,
          "goals": [
            "a, b: BoundedSet\n\nBoundedRel a b <-> b = join_BoundedSet a b"
          ]
        },
        {
          "term": {
        ...
        },
        {
          ...
          "goals": [
            "a, b: BoundedSet\n\nBoundedRel a b -> b = join_BoundedSet a b",
            "a, b: BoundedSet\n\nb = join_BoundedSet a b -> BoundedRel a b"
          ]
        },
        {
          "term": {
        ...
        },
        {
          ...
          "step": {
            "text": " induction a; induction b; auto; unfold join_BoundedSet; inversion H.",
            "context": [
              {
                "type": "TermType.DEFINITION",
                "text": "Definition join_BoundedSet (a : BoundedSet) (b : BoundedSet) : BoundedSet := match a with | bottom => b | bounded => match b with | bottom => bounded | _ => b end | top => top end.",
        ...
        },
        {
          ...
          "step": {
            "text": " induction a; induction b; auto; unfold join_BoundedSet in H; inversion H;\n    try apply bot_rel; try apply self_rel; try apply bounded_top_rel.",
            "context": [
              {
                "type": "TermType.DEFINITION",
                "text": "Definition join_BoundedSet (a : BoundedSet) (b : BoundedSet) : BoundedSet := match a with | bottom => b | bounded => match b with | bottom => bounded | _ => b end | top => top end.",
