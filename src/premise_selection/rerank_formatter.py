...
RerankFormatterConf = BasicRerankFormatterConf | ProofRerankFormatterConf
...
def rerank_conf_from_yaml(yaml_data: Any) -> RerankFormatterConf:
    ...
    match attempted_alias:
        ...
        case ProofRerankFormatterConf.ALIAS:
            return ProofRerankFormatterConf.from_yaml(yaml_data)
        case _:
...
RerankFormatter = BasicRerankFormatter | ProofRerankFormatter
...
def rerank_formatter_from_conf(conf: RerankFormatterConf) -> RerankFormatter:
    match conf:
        ...
        case ProofRerankFormatterConf():
            return ProofRerankFormatter.from_conf(conf)
...
def close_rerank_formatter(f: RerankFormatter):
    match f:
        case BasicRerankFormatter():
            pass
        case ProofRerankFormatter():
            f.proof_retriever.close()
