...
class PremiseVectorDB:
    ...
    def page_loc(self, idx: int) -> Path:
        return self.db_loc / f"{idx}.pt"
    ...
    def save(self):
        ...
        metadata = {
            ...
            "retriever_checkpoint_loc": str(self.retriever_checkpoint_loc),
        }
    ...
    def load(
        ...
        return cls(
            db_loc,
            metadata["page_size"],
            Path(metadata["retriever_checkpoint_loc"]),
            metadata["sdb_hash"],
        )
