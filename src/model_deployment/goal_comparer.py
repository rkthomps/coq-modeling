...
d = {'v': {'control': [],
  'attrs': [],
  'expr': ['VernacDefinition',
   [['NoDischarge'], ['Definition']],
   [{'v': ['Name', ['Id', 'def_one']]}, None],
   ['DefineBody',
    [],
    None,
    {'v': ['CNotation',
      None,
      [['InConstrEntry'], 'exists _ .. _ , _'],
      [[{'v': ['CNotation',
          None,
          [['InConstrEntry'], '_ = _'],
          [[{'v': ['CCases',
              ...
              [[{'v': ['CApp',
                  {'v': ['CRef',
                    {'v': ['Ser_Qualid', ['DirPath', []], ['Id', 'min']]},
                    None]},
                  [[{'v': ['CRef',
                      {'v': ['Ser_Qualid', ['DirPath', []], ['Id', 'l']]},
                      None]},
                    None]]]},
                None,
                None]],
              [{'v': [[[{'v': ['CPatCstr',
                     {'v': ['Ser_Qualid', ['DirPath', []], ['Id', 'Some']]},
                     None,
                     [{'v': ['CPatAtom',
                        {'v': ['Ser_Qualid',
                          ['DirPath', []],
                 ...
                 {'v': ['CIf',
                   {'v': ['CNotation',
                     ...
                     [['InConstrEntry'], '_ <? _'],
                     [[{'v': ['CRef',
                         {'v': ['Ser_Qualid', ['DirPath', []], ['Id', 'n']]},
                         None]},
                       {'v': ['CRef',
                         {'v': ['Ser_Qualid', ['DirPath', []], ['Id', 'm']]},
                         None]}],
                      [],
                      [],
                      []]]},
