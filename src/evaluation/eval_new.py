...
from model_deployment.prove import load_summary, errored_summary
from evaluation.eval_utils import EvalConf, create_eval_proof_map, get_save_name
...
def get_proofs_to_add(
    ...
    for f_info, i in proofs:
        ...
        for n in existing_names:
            ...
            if n.startswith(file_info.dp_name) and n.endswith(f"-{i}.json"):
