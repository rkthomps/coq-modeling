...
Once you have composed your LmExample subclass, you can use the file [create_lm_dataset.py](data_management/create_lm_dataset.py) to convert the raw data into a dataset of examples. 
